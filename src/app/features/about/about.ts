...
export class About {
  ...
  readonly aboutSubTitle = 'Découvrez mon parcours, mes compétences et ma passion pour le développement web.';
  ...
  readonly socialButtons = [
    { icon: 'simple-icons:linkedin', label: 'LinkedIn', href: 'https://www.linkedin.com/in/julien-nedellec/' },
  ...
  readonly highlights: readonly Highlight[] = [
    {
      ...
      description: 'Toujours en quête de nouvelles connaissances pour rester à la pointe du développement web.',
      icon: 'ph:student-bold',
    },
    {
      title: "Esprit d'équipe",
      description: 'Collaboration et partage sont au cœur de ma façon de travailler pour livrer des projets ambitieux.',
      icon: 'ph:users-three',
    },
    {
      title: 'Curieux de nature',
      description: 'Exploration permanente de nouvelles approches et solutions créatives pour les défis techniques.',
      icon: 'ph:lightbulb-filament-bold',
    },
    {
      title: 'Pensée analytique',
      description: 'Analyse fine des problèmes complexes pour imaginer des réponses élégantes et performantes.',
      icon: 'ph:brain',
    },
  ] as const;
  ...
  readonly diplomas: readonly Diploma[] = [
    {
      ...
      tooltip: {
        ...
        skills: ['HTML5, CSS3, JavaScript', 'Angular & TypeScript', 'SQL & NoSQL', 'Git & GitHub', 'Responsive Design', 'API REST'],
      },
    },
    {
      id: 'pgi-erp',
      ...
      tooltip: {
        ...
        skills: ['HTML5, CSS3, JavaScript, jQuery', 'Java & J2EE', 'MySQL, UML & modélisation', 'Git & gestion de version', 'Algorithmique & design patterns', 'Méthodes agiles (Scrum, RUP)'],
      },
    },
  ];
